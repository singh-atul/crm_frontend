...
function Engineer() {
    ...
    return (
        <div className="container my-2">
            <h3 className="text-info">ENGINEER DASHBOARD</h3>
                ...
                <div className="col">
                    <div className="card shadow" style={{ width: 15 + 'rem' }}>
                        <div className="card-body">
                            <h5 className="card-subtitle mb-2 text-info">Card 1</h5>
                            <hr />
            ...
            <div className="row my-4">
                ...
                <div className="col">
                    <div className="card shadow" style={{ width: 50.7 + 'rem' }}>
                        <div className="card-body">
                            <h5 className="card-subtitle mb-2 text-info">Get Tickets</h5>

                            <div >
                                <div className="input-group my-1">
                                    <input type="text" className="form-control" placeholder="Search..." id="search" /><i className="bi bi-search btn btn-outline-secondary text-info"></i>
                                </div>
                ...
                <div className="col">
                    <div className="card m shadow" style={{ width: 15 + 'rem' }}>
                        <div className="card-body">
                            <h5 className="card-subtitle mb-2 text-info">Edit Ticket</h5>
                            <hr />
                            <div className="col">
                            <div>
